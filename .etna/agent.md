...
- **safety:input-jailbreak** — The existing refusal instruction can be made more robust against jailbreak attempts by explicitly mentioning evasive or malicious prompts.
