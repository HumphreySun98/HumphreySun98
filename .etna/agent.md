...
- **behavior:tone-under-pressure** — The agent needs an explicit instruction to maintain its professional tone under pressure, which is not covered by existing instructions.
