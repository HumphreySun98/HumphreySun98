...
- **intent-comprehension** — The agent currently lacks an explicit instruction on how to handle vague or general user input, which can lead to unhelpful or off-topic responses.
